/* Shared recipe and attempt data for Sesame Rolls. */
(function () {
  const archive1Recipe = {
    ingredients: [
  ...
  window.SesameRolls = {
    ...
    recipeName: 'Sesame Rolls',
    intro: 'Soft enriched rolls with a sweet black sesame filling and sesame cream cheese frosting.',
    yieldLabel: 'rolls',
    baseServings: 12,
    time: '3 hr',
    level: 'Intermediate',
    ...
    attempts: [
      {
        id: 'archive-1', badge: 'A1', label: 'Archive 1', order: 1, rating: 4.5,
        date: 'Date unknown', dateShort: 'Date unknown',
        href: 'archive1/index.html',
        photo: 'archive1/baked.jpeg', caption: 'archive 1, baked',
        tagline: 'from the archive',
        cardNote: 'Sweet black sesame rolls from before the attempt log.',
        note: 'Sugar levels were a little high, though people who like sweeter treats enjoyed them. Double the filling next time.',
        recipe: archive1Recipe,
      },
    ],
  };
})();
